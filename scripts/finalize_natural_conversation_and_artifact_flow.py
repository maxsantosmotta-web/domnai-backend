...
# Backend: regras naturais de conversa e texto posterior ao arquivo.
prompt_path = Path('/app/app/services/domnai_brain.py')
worker_path = Path('/app/app/services/chat_task_worker.py')
if prompt_path.exists() and worker_path.exists():
...
# Frontend: inserir mensagem separada após o cartão do arquivo.
...
require(prompt_path.exists() or dashboard_path.exists(), 'Nenhuma etapa conhecida do build foi encontrada.')
