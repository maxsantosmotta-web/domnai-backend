...
# 1. Cria um bloco no rodapé somente para Perfil + Sair da conta.
...
# 2. Preserva a função do logout e apenas o encaixa abaixo do perfil.
...
# 3. Carrega os estilos depois dos refinamentos atuais.
...
print('Painel Adm restaurado à seção anterior; bloco inferior mantém Perfil e Sair da conta.')
