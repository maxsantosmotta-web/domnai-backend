...
# 1. Cria no rodapé um slot separado para o Painel Adm e um bloco para Perfil + Sair da conta.
...
replacement = (
    f'{indent}<div className="domnai-user-footer-area">\n'
...
# 2. Mantém o botão Adm original e apenas muda seu destino para o slot do rodapé.
...
# 3. Preserva a função do logout e apenas o encaixa abaixo do perfil.
...
# 4. Carrega os estilos depois dos refinamentos atuais.
...
print('Painel Adm mantido no rodapé fora da caixa; Perfil e Sair da conta permanecem unidos.')
